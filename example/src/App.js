...
const App = () => {
  ...
  return (
    <>
      <SimpleCarouselSlider images={images} wdith="100%" height="600px" parallax={true} autoplay={true} />
      <section>
        <table>
          <tr>
            <th>Name</th>
          ...
          <tr><td>width</td><td>Number</td><td>Optional</td><td>	Image Slider Width</td><td></td></tr>
          <tr><td>height</td><td>Number</td><td>Optional</td><td>	Image Slider Height</td><td></td></tr>
